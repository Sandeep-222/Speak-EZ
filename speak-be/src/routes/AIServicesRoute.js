...
const { uploadDocument,Getquestions,WETQuestion,EnglishScore,RandomText,VocalScore,EnglishScore1} = require('../controllers/AIController');

const upload = multer();
Router.post('/English-Score',EnglishScore);
Router.post('/English-Score-updated',EnglishScore1);
